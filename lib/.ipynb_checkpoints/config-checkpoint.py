...
# module
cfg.train_dataset_module = 'lib.scannet'
cfg.test_dataset_module = 'lib.scannet'
cfg.network_module = 'lib.network'
cfg.trainer_module = 'lib.trainers'
cfg.evaluator_module = 'lib.mesh'
...
parser.add_argument("--cfg_file", default="default.yaml", type=str)
parser.add_argument('--test', action='store_true', dest='test', default=False)
parser.add_argument("--type", type=str, default="")
parser.add_argument('--det', type=str, default='')
parser.add_argument('--local_rank', type=int, default=0)
parser.add_argument('--output_mesh', type=str, default='result.obj')
